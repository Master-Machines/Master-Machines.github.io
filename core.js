...
function fadeToBlack(){
	...
	setTimeout(function(){
		...
		$('#gamePlayer').after("<div><label id='fullScreenMessage' style='color:#0f0; opacity: .4'>Press the 'f' key to enter fullscreen. You must not be in the main menu for this to work.</label></div>");
	},1000);
}
